...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { supp_address: @supplier.supp_address, supp_name: @supplier.supp_name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { supp_address: @supplier.supp_address, supp_name: @supplier.supp_name } }
